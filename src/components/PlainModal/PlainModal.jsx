...
const PlainModal = (props) => {
	const {
		children, shouldModalBeVisible, exposeIsModalVisible, isCloseIconVisible
	} = props;
	...
	return (
		<div styleName={`modal ${modalVisibilityClass}`} id="modal" role="presentation" onClick={handleCloseModalViaOverLayClose}>
			<div styleName="modal__container" id="modal__container">
				{
					isCloseIconVisible
				&& (
					<div styleName="modal__close-icon" role="presentation" onClick={handleCloseModalViaCloseIcon}>
						<img src={""} alt="Close" />
					</div>
				)}
				{children}
